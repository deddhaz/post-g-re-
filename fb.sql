...
qq2.question as "Pertanyaan",
qq4.answer as "Jawabannya",
...
cc.title like '%Interviewing :%' and 
qq4.answer is not null 
--qq4.answer like '%&%'
group by uu.username, uu.first_name,qq.status_changed, qq.assignee_id, qq.title, ss2,type, qq2.attributes, cc.title, ss3.title,qq2.question,qq4.answer,uu.first_name
